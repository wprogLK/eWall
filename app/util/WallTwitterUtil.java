...
public class WallTwitterUtil 
{
	public static Twitter setupTwitter(String oAuthAccessToken, String oAuthAccessTokenSecret)
	{
		...
		cb.setOAuthAccessToken(oAuthAccessToken);//"220058348-KPaT8hkUK2AEJu7uzhQQBGzSPJ8Avk9eN6LoW1Hd");//oAuthAccessToken);
		cb .setOAuthAccessTokenSecret(oAuthAccessTokenSecret);//"O2tizT5EcXUH5zId5J8SPNPpqwKcYp7Jufhuy4puLoQ");//oAuthAccessTokenSecret);
